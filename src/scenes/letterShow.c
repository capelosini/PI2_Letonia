...
void loadLetterShow(){
    ...
    letterShowText = createText(lettersTexts[3], back->position.x+150, back->position.y+180, engine->displayWidth/2-280, al_map_rgb(10,10,10), al_map_rgba(0,0,0,0), NULL, loadTTF(engine, "./assets/fonts/roboto.ttf", 40), 40, 20, letterShow);
